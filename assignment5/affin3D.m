...
x7 = [points(23,:),1];
% 
line3 = pluker(x4'*x5 - x5'*x4);
line4 = pluker(x6'*x7 - x7'*x6);
[~,~,V] = svd([line3;line4]);
pt2 = V(:,end)
% 
% 
...
line5 = pluker(x8'*x9 - x9'*x8)';
line6 = pluker(x10'*x11 - x11'*x10)';
[U,S,V] = svd([line5;line6]);
pt3 = V(:,end);

%fourthe point to be considered
x12 = [points(1,:),1];
x13 = [points(7,:),1];
x14 = [points(2,:),1];
x15 = [points(8,:),1];

line7 = pluker(x12'*x13 - x13'*x12)';
line8 = pluker(x14'*x15 - x15'*x14)';
[U,S,V] = svd([line7;line8]);
pt4 = V(:,end)
% 
[U,S,V] = svd([pt1';pt2';pt3';pt4']);
H = zeros(4,4);
H(1:3,1:3) = eye(3);
H(4,:) = V(:,end);
disp(H)
